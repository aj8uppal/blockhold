...
const defs: Record<string, string> = {
  ...
  seraph: `<g ${S}><path d="M12 5.2v14.2"/><path d="M12 8.6c-2.4-3.2-6.2-3.6-9.2-1.4 2.2 1.6 3.6 3.8 4.4 6.4"/><path d="M12 8.6c2.4-3.2 6.2-3.6 9.2-1.4-2.2 1.6-3.6 3.8-4.4 6.4"/><path d="M8.6 19.4h6.8"/></g><circle cx="12" cy="3.6" r="2" fill="none" stroke="currentColor" stroke-width="1.6"/>`,
