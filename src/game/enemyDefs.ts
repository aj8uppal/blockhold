...
const defs: EnemyDef[] = [
  ...
  },
  {
    ...
    model: 'veilregent', scale: 1.45,
    description: 'The last will of the Veil: a phasing colossus that sings its own heralds into being.',
  },
  {
    id: 'ossuary', name: 'The Ossuary', hp: 6500, speed: 0.26, armor: 0.4, magicResist: 0.25,
    bounty: 520, livesCost: 20, boss: true, shardDrop: 2,
    raises: { radius: 3, id: 'husk' },
    attackDamage: [38, 56], attackInterval: 2.1,
    model: 'ossuary', scale: 1.5,
    description: 'A colossus of bone. Whatever dies near it stands back up and walks on. Kill it first, or kill nothing.',
  },
  {
    id: 'veilempress', name: 'The Veil Empress', hp: 4000, speed: 0.3, armor: 0.2, magicResist: 0.45,
    bounty: 350, livesCost: 20, boss: true, flying: true, yOffset: 1.0,
    phasing: { interval: 6, duration: 0.9 },
    summons: { id: 'riftwing', count: 2, interval: 14 },
    phaseInto: 'veilempressLanded',
    attackDamage: [0, 0], attackInterval: 1,
    model: 'veilempress', scale: 1.55,
    description: 'The Veilqueen\'s matriarch. She flies and fades and calls Riftwings; break her wings and she will walk the rest of the way.',
  },
  {
    id: 'veilempressLanded', name: 'The Veil Empress, Grounded', hp: 3500, speed: 0.32, armor: 0.4, magicResist: 0.4,
    bounty: 400, livesCost: 20, boss: true, shardDrop: 4,
    summons: { id: 'riftherald', count: 1, interval: 16 },
    attackDamage: [40, 58], attackInterval: 1.8,
    model: 'veilempressLanded', scale: 1.55,
    description: 'Wingless and furious. She walks now, and everything you built for the ground finally has something to hit.',
  },
  {
