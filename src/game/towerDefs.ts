    ...
    branches: [
      {
        ...
        damage: [34, 50], damageType: 'physical', attackInterval: 0.12, flying: true, beamTargets: 6,
        special: { kind: 'crit', chance: 0.25, mult: 2.5 },
        description: 'Six separate beams strike enemies in range. One volley in four is a solar flare dealing 2.5x damage.',
      },
      {
        name: 'Void Seraph', cost: 3600, model: 'seraph4b', range: 4.6,
        damage: [40, 58], damageType: 'magic', attackInterval: 0.14, flying: true, beamTargets: 6,
        special: { kind: 'armorShred', amount: 0.04 },
        description: 'Six separate magic beams ignore armor and strip 4% from each target.',
      },
    ],
    capstones: [
      {
        name: 'The Dawnbringer', cost: 7500, model: 'seraph5a', range: 5.6,
        damage: [60, 90], damageType: 'physical', attackInterval: 0.1, flying: true, beamTargets: 7,
        special: { kind: 'crit', chance: 0.3, mult: 2.5 },
        signature: 'dawnfall',
        description: 'Ten volleys a second, firing 7 separate beams at enemies in range. Every eight seconds, Dawnfall: a column of true light on the toughest thing in reach for 600, leaving the road burning.',
      },
      {
        name: 'The Eventide', cost: 7500, model: 'seraph5b', range: 5.0,
        damage: [90, 130], damageType: 'magic', attackInterval: 0.14, flying: true, beamTargets: 7,
        special: { kind: 'armorShred', amount: 0.06 },
        signature: 'eclipse',
        description: 'Seven separate magic beams, full damage to each target in range. Every ten seconds, an Eclipse: everything in reach is stunned for 1.5s and loses a fifth of its armor and resistance.',
      },
    ],
  },
}
