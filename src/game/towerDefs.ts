    ...
    levels: [
      {
        ...
        damage: [7, 11], damageType: 'physical', attackInterval: 0.16, flying: true, beamTargets: 3,
    ...
    branches: [
      {
        ...
        damage: [30, 42], damageType: 'physical', attackInterval: 0.14, flying: true, beamTargets: 7,
        special: { kind: 'crit', chance: 0.2, mult: 2 },
        description: 'Wide coverage: 7 separate solar beams per volley. One volley in five flares for double damage. Reaches scattered enemies across its range.',
      },
      {
        name: 'Void Seraph', cost: 3600, model: 'seraph4b', range: 4.6,
        damage: [230, 290], damageType: 'magic', attackInterval: 0.55, flying: true, splash: 1.15,
        special: { kind: 'armorShred', amount: 0.04 },
        description: 'Dark laser pulses hit every enemy within 1.15 tiles of impact, including flyers. Full damage with no target cap; ignores armor and magic resistance. Strips 4% armor per hit.',
      },
    ],
    capstones: [
      {
        name: 'The Dawnbringer', cost: 7500, model: 'seraph5a', range: 5.6,
        damage: [50, 70], damageType: 'physical', attackInterval: 0.115, flying: true, beamTargets: 8,
        special: { kind: 'crit', chance: 0.2, mult: 2.5 },
        signature: 'dawnfall',
        description: 'Sweeps packed roads with 8 lighter beams. One volley in five flares for 2.5x damage. Every eight seconds, Dawnfall strikes the toughest foe for 600 true damage and leaves burning ground.',
      },
      {
        name: 'The Eventide', cost: 7500, model: 'seraph5b', range: 5.0,
        damage: [430, 550], damageType: 'magic', attackInterval: 0.48, flying: true, splash: 1.45,
        special: { kind: 'armorShred', amount: 0.06 },
        signature: 'eclipse',
        description: 'Stronger void pulses hit every enemy within 1.45 tiles, ignoring armor and magic resistance. Every ten seconds, Eclipse stuns the four strongest foes in reach for 1.5s and strips a fifth of their defenses.',
      },
    ],
  },
}
