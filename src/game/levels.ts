...
const emberwastesWaves: WaveDef[] = [
  ...
  { groups: [g('brute', 2, 9), g('warlock', 5, 2.4, 4, 1), g('sprinter', 10, 0.9, 8), g('shardback', 2, 6, 12)] },
  { groups: [g('husk', 20, 0.7, 0, 1), g('spiderling', 14, 0.5, 6), g('acolyte', 5, 2.0, 10, 1)] },
  { groups: [g('broodmother', 2, 10, 2), g('shield', 10, 1.5, 5, 1), g('gargoyle', 9, 1.3, 9), g('shardback', 2, 6, 12, 1)] },
  ...
  { groups: [g('broodmother', 2, 9, 0, 1), g('spiderling', 20, 0.45, 4), g('shield', 9, 1.4, 8, 1)] },
...
const mistfenWaves: WaveDef[] = [
  ...
  { groups: [g('mistwalker', 6, 1.3), g('warlock', 3, 2.7, 3, 1), g('husk', 4, 1.2, 7)] },
  { groups: [g('mistwalker', 6, 1.25, 0, 1), g('gargoyle', 6, 1.5), g('shield', 3, 2.0, 5, 1)] },
  { groups: [g('mistwalker', 7, 1.2), g('sprinter', 5, 1.0, 2, 1), g('acolyte', 3, 2.2, 5)] },
  { surge: true, groups: [g('mistwalker', 8, 1.05, 0, 1), g('spiderling', 12, 0.5), g('broodmother', 1, 1, 6, 1), g('warlock', 2, 2.5, 9)] },
  { groups: [g('mistwalker', 8, 1.1), g('brute', 1, 1, 3, 1), g('shield', 5, 1.7, 7), g('shardback', 2, 5, 9, 1)] },
  ...
  { groups: [g('broodmother', 2, 8), g('brute', 2, 8, 3, 1), g('mistwalker', 8, 0.85, 6)] },
...
const shatteredcrownWaves: WaveDef[] = [
  ...
  { groups: [g('brute', 1, 1), g('brute', 1, 1, 2, 1), g('brute', 1, 1, 4, 2), g('spiderling', 12, 0.45, 6), g('spiderling', 12, 0.45, 7, 1), g('spiderling', 12, 0.45, 8, 2)] },
  { groups: [g('broodmother', 1, 1), g('broodmother', 1, 1, 1, 1), g('broodmother', 1, 1, 2, 2), g('mistwalker', 3, 1.0, 4), g('mistwalker', 3, 1.0, 5, 1), g('mistwalker', 3, 1.0, 6, 2), g('shardback', 2, 5, 9)] },
...
const cinderwakeWaves: WaveDef[] = [
  ...
  { groups: [g('mistwalker', 6, 1.2, 0, 1), g('riftwing', 4, 1.5, 3, 2), g('acolyte', 5, 1.8, 6)] },
  ...
  { groups: [g('brute', 2, 8, 0, 1), g('acolyte', 6, 1.7, 3), g('shield', 8, 1.4, 6, 2)] },
  ...
  { groups: [g('riftwing', 6, 1.2, 0, 1), g('gargoyle', 10, 1.0, 3, 2), g('broodmother', 2, 8, 6)] },
...
const veilscarWaves: WaveDef[] = [
  ...
  { groups: [g('mistwalker', 8, 1.0), g('gargoyle', 8, 1.2, 3, 1), g('acolyte', 6, 1.7, 6, 2), g('shardback', 2, 5, 10, 1)] },
  { surge: true, groups: [g('brute', 2, 8, 0, 1), g('riftwing', 5, 1.3, 3, 2), g('spiderling', 16, 0.45, 6)] },
  { groups: [g('riftherald', 2, 9, 2), g('warlock', 5, 1.9, 0, 1), g('shield', 8, 1.35, 5, 2)] },
  ...
  { groups: [g('brute', 3, 7), g('spiderling', 22, 0.38, 4, 1), g('riftherald', 2, 9, 8, 2)] },
...
export function generateEndlessWaves(level: LevelDef, count = 999): WaveDef[] {
  ...
  for (let i = 0; i < count; i++) {
    ...
    const pool = [
      ...
      ['shield', 'gargoyle', 'acolyte', 'warlock', 'mistwalker', 'spiderling', 'shardback', 'riftwing'],
      ['shield', 'gargoyle', 'acolyte', 'warlock', 'mistwalker', 'broodmother', 'brute', 'shardback', 'riftwing', 'riftherald'],
    ][tier]
    const groups = []
    const groupCount = 2 + Math.min(3, Math.floor(i / 6))
    const rare = (enemy: string) => enemy === 'brute' || enemy === 'broodmother' || enemy === 'riftherald'
