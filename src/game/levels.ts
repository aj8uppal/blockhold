...
export const levels: LevelDef[] = [
  ...
  },
  {
    ...
    plateaus: [[3, 8, 6, 11, 0.9]],
    landmarks: [[4, 1, 'spire'], [10, 1, 'ruin']],
  ...
  },
  {
    ...
    plateaus: [[15, 8, 19, 11, 1.0], [4, 2, 6, 4, 0.7]],
    landmarks: [[1, 1, 'greatTree'], [7, 1, 'monolith'], [15, 1, 'arch']],
  ...
  },
  {
    ...
    plateaus: [[10, 6, 14, 9, 1.3], [2, 10, 5, 12, 0.8]],
    landmarks: [[1, 1, 'spire'], [7, 1, 'spire'], [18, 1, 'ruin'], [14, 5, 'monolith']],
  ...
  },
  {
    ...
    plateaus: [[7, 3, 11, 6, 1.4], [17, 9, 21, 12, 1.0]],
    landmarks: [[9, 1, 'arch'], [15, 1, 'spire'], [21, 3, 'ruin'], [1, 4, 'monolith']],
  ...
  },
  {
    ...
    plateaus: [[9, 5, 14, 9, 1.8], [2, 2, 5, 4, 1.1], [20, 10, 24, 13, 1.2]],
    landmarks: [[10, 1, 'monolith'], [15, 3, 'monolith'], [1, 4, 'arch'], [21, 4, 'spire'], [6, 5, 'ruin']],
