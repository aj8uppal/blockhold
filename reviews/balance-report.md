...
| 4 | 1,126 | 138 | 25.0 / 59.5 (gold 826) | arrival 653.0 HP/s; fly 26.2%; armor≥0.4 30.8%; MR≥0.5 0.0%; no pressure flag |
| 5 | 1,419 | 144 | 31.5 / 70.9 (gold 984) | arrival 1,258.0 HP/s; fly 0.0%; armor≥0.4 0.0%; MR≥0.5 54.8%; no pressure flag |
| 6 | 1,524 | 182 | 33.9 / 82.7 (gold 1,148) | arrival 1,085.4 HP/s; fly 33.2%; armor≥0.4 43.6%; MR≥0.5 0.0%; no pressure flag |
| 7 | 1,382 | 174 | 30.7 / 97.2 (gold 1,350) | arrival 1,180.6 HP/s; fly 0.0%; armor≥0.4 0.0%; MR≥0.5 40.6%; no pressure flag |
| 8 | 1,358 | 146 | 30.2 / 111.2 (gold 1,544) | arrival 1,269.2 HP/s; fly 28.3%; armor≥0.4 0.0%; MR≥0.5 71.7%; no pressure flag |
| 9 | 1,866 | 168 | 41.5 / 123.2 (gold 1,710) | arrival 1,588.8 HP/s; fly 0.0%; armor≥0.4 65.6%; MR≥0.5 0.0%; no pressure flag |
| 10 | 5,593 | 388 | 124.3 / 136.7 (gold 1,898) | arrival 5,328.4 HP/s; fly 0.0%; armor≥0.4 79.8%; MR≥0.5 8.2%; no pressure flag |
| 11 | 2,031 | 235 | 45.1 / 166.1 (gold 2,306) | arrival 1,517.3 HP/s; fly 35.9%; armor≥0.4 0.0%; MR≥0.5 38.9%; no pressure flag |
| 12 | 3,265 | 250 | 72.5 / 184.5 (gold 2,561) | arrival 2,264.2 HP/s; fly 0.0%; armor≥0.4 32.5%; MR≥0.5 34.0%; no pressure flag |
| 13 | 3,162 | 306 | 70.3 / 203.9 (gold 2,831) | arrival 2,451.7 HP/s; fly 19.2%; armor≥0.4 14.1%; MR≥0.5 19.4%; no pressure flag |
| 14 | 2,343 | 201 | 52.1 / 227.4 (gold 3,157) | arrival 1,553.4 HP/s; fly 35.0%; armor≥0.4 0.0%; MR≥0.5 0.0%; no pressure flag |
| 15 | 3,616 | 314 | 80.3 / 243.3 (gold 3,378) | arrival 1,552.2 HP/s; fly 0.0%; armor≥0.4 33.1%; MR≥0.5 60.2%; no pressure flag |
| 16 | 2,889 | 246 | 64.2 / 267.4 (gold 3,712) | arrival 2,237.4 HP/s; fly 0.0%; armor≥0.4 0.0%; MR≥0.5 0.0%; no pressure flag |
| 17 | 3,504 | 304 | 77.9 / 286.5 (gold 3,978) | arrival 2,061.5 HP/s; fly 31.9%; armor≥0.4 15.1%; MR≥0.5 53.0%; no pressure flag |
| 18 | 3,333 | 238 | 74.1 / 309.9 (gold 4,302) | arrival 2,769.0 HP/s; fly 22.6%; armor≥0.4 0.0%; MR≥0.5 21.4%; no pressure flag |
| 19 | 7,038 | 472 | 156.4 / 328.4 (gold 4,560) | arrival 6,993.2 HP/s; fly 81.6%; armor≥0.4 0.0%; MR≥0.5 0.0%; no pressure flag |
| 20 | 4,909 | 330 | 109.1 / 363.9 (gold 5,052) | arrival 3,882.6 HP/s; fly 0.0%; armor≥0.4 50.4%; MR≥0.5 28.3%; no pressure flag |
| 21 | 3,926 | 246 | 87.2 / 389.1 (gold 5,402) | arrival 1,020.2 HP/s; fly 0.0%; armor≥0.4 0.0%; MR≥0.5 67.7%; no pressure flag |
| 22 | 4,833 | 319 | 107.4 / 408.2 (gold 5,668) | arrival 4,734.6 HP/s; fly 23.4%; armor≥0.4 38.2%; MR≥0.5 0.0%; no pressure flag |
| 23 | 4,991 | 323 | 110.9 / 432.7 (gold 6,007) | arrival 3,301.1 HP/s; fly 54.1%; armor≥0.4 13.9%; MR≥0.5 32.0%; no pressure flag |
| 24 | 7,033 | 322 | 156.3 / 457.4 (gold 6,350) | arrival 2,752.3 HP/s; fly 0.0%; armor≥0.4 0.0%; MR≥0.5 26.8%; no pressure flag |
| 25 | 12,062 | 476 | 268.0 / 482.0 (gold 6,692) | arrival 11,971.1 HP/s; fly 0.0%; armor≥0.4 70.7%; MR≥0.5 11.6%; no pressure flag |
| 26 | 8,090 | 439 | 179.8 / 517.7 (gold 7,188) | arrival 7,438.2 HP/s; fly 17.4%; armor≥0.4 36.6%; MR≥0.5 26.4%; no pressure flag |
| 27 | 8,267 | 369 | 183.7 / 550.8 (gold 7,647) | arrival 3,819.9 HP/s; fly 0.0%; armor≥0.4 15.2%; MR≥0.5 26.2%; no pressure flag |
| 28 | 20,322 | 783 | 451.6 / 578.8 (gold 8,036) | arrival 20,008.1 HP/s; fly 13.5%; armor≥0.4 0.0%; MR≥0.5 5.9%; no pressure flag |
