...
describe('loadSave', () => {
  ...
  it('returns defaults for non-object JSON', () => {
    for (const raw of ['null', '42', '"not an object"']) {
      ...
      expect(loadSave()).toEqual({ unlocked: 1, stars: {}, armory: {}, bestEndless: {}, bestFreeplay: {}, bestScore: {}, medals: {}, trials: {}, capstones: [], seenEnemies: [], taughtBasics: false, lastHero: 'aldric', sfxMuted: false, musicMuted: false, xp: 0 })
    }
  })
...
describe('save durability', () => {
  const sample: SaveData = {
    ...
    medals: { greenhollow: ['noleak'] }, trials: {}, capstones: [], seenEnemies: ['juggernaut'], taughtBasics: true, lastHero: 'liora', sfxMuted: false, musicMuted: true, xp: 1234,
  }
